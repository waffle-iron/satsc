						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									...
									<li><a href="#" class="active">Paid Loans</a></li>
								</ul>
							</div>
						</li>
				...
				<div class="container-fluid">
					...
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title"><strong>PAID LOANS</strong></h3>
							<p class="panel-subtitle">A summary of loan applications that has been paid.</p>
						</div>
