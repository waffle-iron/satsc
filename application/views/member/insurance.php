				...
				<div class="container-fluid">
					...
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title"><strong>INSURANCE DETAILS</strong></h3>
							<p class="panel-subtitle">Logged in as Joeylene Rivera</p>
						</div>
						<div class="panel-body">
							<h4><strong>Member ID: </strong>14124</h4>
							<h4><strong>Name: </strong>Joeylene Rivera</h4>
							<h4><strong>Member Type: </strong>Jeepney Operator</h4>
							<br>
							<h4><strong>Last Insurance: </strong>PHP 1,233 - June 18, 2017</h4>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title"><strong>INSURANCE HISTORY</strong></h3>
							</div>
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title"><strong>INSURANCE REQUIREMENTS</strong></h3>
							</div>
							<div class="panel-body">
								<p>1.PAMI CHU CHU</p>
							</div>
